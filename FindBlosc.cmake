...
#set(BLOSC_LIBRARIES "")
#foreach (LIBNAME ${CONAN_LIBS_BLOSC})
#    find_library(BLOSC_${LIBNAME}_LIBRARY NAMES ${LIBNAME} PATHS ${BLOSC_LIBRARY_DIRS})
#    list(APPEND BLOSC_LIBRARIES "${BLOSC_${LIBNAME}_LIBRARY}")
#endforeach()
